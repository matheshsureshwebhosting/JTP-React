 ...
 */}
                    <nav class="navbar navbar-default navbar-fixed-top" id="navbar">
                        <div class="container-fluid">
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href={"jd"}>About Us<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href={"jd"}>Products/Capabilities<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href={"jd"}>Facilities/Machinery/Equipment<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href={"jd"}>Engineering capabilities<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href={"jd"}>Gallery<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu">
                   ...
                   {/*  <!------ SIDE MENU END ------>
                    ...
                    <div class="banner" data-parallax="scroll" data-image-src="assets/img/skult.png">
                        <ul class="breadcrumb">
                            <li class="one"><a href={"jd"}>Home</a></li>
                            <li class="two"><a href={"jd"}>Tool-Room</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="box">
                            <div class="one">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <img src="assets/img/tool.jpg" alt="gh" class="img img-responsive"/>
                                        <h2>Enkey's CNC Machining</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="two">
                            ...
                            <div class="three">
                                <p>We work with an objective to provide maximum satisfaction to the clients in terms of quality,
                                 performance, price and timely delivery. Consequently, we are reckoned as one of the credible Telecommunication Parts Manufacturers & Suppliers based in India.</p>
                                <p>Do try our high precision machining services if you have a precision part that you need to get manufactured. We guarantee
                                 you full adherence to your specifications.</p>
                            </div>
                            <div class="four">
                                <ul class="breadcrumb">
                    ...
                    <div class="footer">
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Home</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>About Us</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Capabilities</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Certification</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Solution to Customers</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Contuct Us</a></li>
                                    </ul>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    <h3 class="second-heading">PRODUCTS</h3>
                                    <ul class="list-unstyled">
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Aluminium Pressure Die Casting</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Components</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Aluminium Gravity Die Casting</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Components</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Cast Iron and Nodular Iron</a></li>
                                    </ul>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                    <h3 class="third-heading">MACHINERY</h3>
                                    <ul class="list-unstyled">
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Pressure Die Casting Facilities</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Gravity Die Casting Facilities</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Testing and Measuring Facilities</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Machining Facilities</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Finishing Facilities</a></li>
                                        <li><a href={"jd"}><i class="fa fa-caret-right" aria-hidden="true"></i>Leak Test Facilities</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="copyrights">
                                <div class="container-fluid">
                                    ...
                                    <summary><b>ENKEY</b> &copy 2020  Deccan Engineering Works. All Rights Reserved. - Site By: <img alt="gh" src="assets/img/footer-enkey.png"/></summary>
                                </div>
                            </div>
                    </div>
